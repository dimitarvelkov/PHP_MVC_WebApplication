<form class="form-horizontal col-sm-10 col-sm-offset-1" action="/posts/editPost" method="post" >
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" value="" name="post_title" class="form-control" id="post_title" placeholder="Заглавие">
            </div>
        </div>
        <div class="form-group">
            <label for="post_content"  class="col-lg-2 control-label">Съдържание</label>
            <div class="col-lg-10">
                <textarea rows="9"  value="" name="post_content" class="form-control" id="post_content" placeholder="Съдържание"></textarea>
            </div>
        </div>
        <div class="form-group">
            <label for="post_tag" class="col-lg-2 control-label">Тагове</label>
            <div class="col-lg-10">
                <input type="text"  value="" name="post_tag" class="form-control" id="post_tag" placeholder="Тагове">
            </div>
        </div>
        <div class="form-group">
